...
const PartnerDashboard = () => {
  ...
  const st = {
    ...
    title: { fontFamily: 'var(--font-headline)', fontSize: 28, fontWeight: 700, color: '#FDF9F3' },
    venueName: { fontSize: 15, color: '#E6BEB2', marginBottom: 28, marginLeft: 44 },
    statsRow: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 32 },
    statCard: { background: '#1C1B1B', borderRadius: '1.5rem', padding: '20px', display: 'flex', alignItems: 'center', gap: 14 },
    statIconWrap: { width: 48, height: 48, borderRadius: '1.5rem', background: '#2A2A2A', display: 'flex', alignItems: 'center', justifyContent: 'center' },
    statIcon: { fontSize: 24, color: '#FFB59E' },
    statValue: { fontFamily: 'var(--font-headline)', fontSize: 22, fontWeight: 700, color: '#FDF9F3' },
    statLabel: { fontSize: 13, color: '#E6BEB2', marginTop: 2 },
    section: { marginBottom: 32 },
    sectionTitle: { fontFamily: 'var(--font-headline)', fontSize: 18, fontWeight: 600, marginBottom: 16, color: '#FDF9F3' },
    bookingItem: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#1C1B1B', borderRadius: '1.5rem', padding: '14px 18px', marginBottom: 10 },
    bookingTime: { fontFamily: 'var(--font-headline)', fontSize: 16, fontWeight: 600, color: '#FFB59E', minWidth: 52 },
    bookingGuest: { fontSize: 15, fontWeight: 500, color: '#FDF9F3' },
    bookingParty: { display: 'flex', alignItems: 'center', gap: 4, fontSize: 13, color: '#E6BEB2', marginTop: 2 },
    ...
    chartContainer: { background: '#1C1B1B', borderRadius: '1.5rem', padding: '24px' },
    chartBars: { display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', height: 160, gap: 12, paddingTop: 8 },
    chartBar: { width: '100%', borderRadius: '6px 6px 0 0', background: 'linear-gradient(135deg, #FFB59E, #FF571A)', minHeight: 8, transition: 'height 0.3s ease' },
    chartLabel: { fontSize: 12, fontWeight: 500, color: '#E6BEB2' },
    chartValue: { fontSize: 11, fontWeight: 600, color: '#FFB59E' },
    reviewCard: { background: '#1C1B1B', borderRadius: '1.5rem', padding: '18px', marginBottom: 12 },
    reviewName: { fontWeight: 600, fontSize: 15, color: '#FDF9F3' },
    reviewDate: { fontSize: 12, color: '#E6BEB2' },
    starFilled: { fontSize: 18, color: '#FFD54F' },
    reviewComment: { fontSize: 14, fontStyle: 'italic', color: '#E6BEB2', lineHeight: 1.5 },
    quickActionBtn: { display: 'flex', alignItems: 'center', gap: 8, padding: '12px 20px', borderRadius: '9999px', border: 'none', background: 'linear-gradient(135deg, #FFB59E, #FF571A)', color: '#3A0B00', fontFamily: 'var(--font-body)', fontSize: 14, fontWeight: 600, cursor: 'pointer', transition: 'transform 0.15s' },
