...
const PartnerDashboard = () => {
  ...
  const [bookings] = useState([
    { id: 1, time: '18:00', guest: 'Nguyễn Văn An', party: 4, status: 'confirmed' },
    { id: 2, time: '18:30', guest: 'Trần Thị Bích', party: 2, status: 'pending' },
    { id: 3, time: '19:00', guest: 'Lê Hoàng Minh', party: 6, status: 'confirmed' },
    { id: 4, time: '19:30', guest: 'Phạm Đức Huy', party: 3, status: 'pending' },
    { id: 5, time: '20:00', guest: 'Võ Thành Tâm', party: 2, status: 'confirmed' },
  ]);
  const [reviews] = useState([
    { id: 1, name: 'Mai Anh', rating: 5, comment: 'Không gian tuyệt vời, món ăn rất ngon. Sẽ quay lại lần nữa!', date: '20/03/2026' },
    { id: 2, name: 'Đức Thịnh', rating: 4, comment: 'Phục vụ tốt, giá cả hợp lý. Nên đặt trước vì quán đông.', date: '19/03/2026' },
