...
const RevenueReport = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#131313', fontFamily: 'var(--font-body)', color: '#FDF9F3', padding: '24px', maxWidth: 1200, margin: '0 auto' }}>
      <button style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4, color: '#FFB59E', fontWeight: 600, fontSize: 14, fontFamily: 'var(--font-body)', marginBottom: 16, padding: 0 }} onClick={() => navigate('/partner')}><span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 20 }}>arrow_back</span>Quay lai</button>
      ...
      <div style={{ background: '#1C1B1B', borderRadius: '1.5rem', padding: '24px', marginBottom: 24 }}>
        <div style={{ fontFamily: 'var(--font-headline)', fontSize: 18, fontWeight: 700, marginBottom: 20, display: 'flex', alignItems: 'center', gap: 8 }}><span aria-hidden="true" className="material-symbols-outlined" style={{ color: '#FFB59E' }}>bar_chart</span>Doanh thu theo ngay</div>
      ...
      <div style={{ background: '#1C1B1B', borderRadius: '1.5rem', padding: '24px', marginBottom: 24 }}>
        <div style={{ fontFamily: 'var(--font-headline)', fontSize: 18, fontWeight: 700, marginBottom: 20, display: 'flex', alignItems: 'center', gap: 8 }}><span aria-hidden="true" className="material-symbols-outlined" style={{ color: '#FFB59E' }}>list_alt</span>Chi tiet giao dich</div>
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 24 }}>
        <button style={{ background: '#2A2A2A', border: 'none', borderRadius: '9999px', padding: '12px 24px', fontSize: 14, fontWeight: 600, fontFamily: 'var(--font-body)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8, color: '#FDF9F3' }}><span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 20 }}>picture_as_pdf</span>Xuat PDF</button>
        <button style={{ background: '#2A2A2A', border: 'none', borderRadius: '9999px', padding: '12px 24px', fontSize: 14, fontWeight: 600, fontFamily: 'var(--font-body)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8, color: '#FDF9F3' }}><span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: 20 }}>table_chart</span>Xuat Excel</button>
      </div>
      <div style={{ background: '#1C1B1B', borderRadius: '1.5rem', padding: '24px' }}>
        <div style={{ fontFamily: 'var(--font-headline)', fontSize: 18, fontWeight: 700, marginBottom: 20, display: 'flex', alignItems: 'center', gap: 8 }}><span aria-hidden="true" className="material-symbols-outlined" style={{ color: '#FFB59E' }}>donut_large</span>Phan bo doanh thu</div>
