...
const AcademyPage = () => {
  ...
  const courses = [
    { id: 1, title: 'Ngôn ngữ cơ thể', instructor: 'Trần Minh', duration: '20 phút', lessons: 6, difficulty: 'Cơ bản', progress: 60, rating: 4.8, category: 'Giao tiếp' },
    { id: 2, title: 'Chọn trang phục hẹn hò', instructor: 'Lê Hoa', duration: '15 phút', lessons: 5, difficulty: 'Cơ bản', progress: 100, rating: 4.9, category: 'Phong cách' },
    { id: 3, title: 'Ăn uống thanh lịch', instructor: 'Phạm Đức', duration: '25 phút', lessons: 8, difficulty: 'Nâng cao', progress: 0, rating: 4.7, category: 'Ẩm thực' },
    { id: 4, title: 'Đọc vị cảm xúc', instructor: 'Nguyễn Lan', duration: '18 phút', lessons: 7, difficulty: 'Nâng cao', progress: 30, rating: 4.6, category: 'Tâm lý' },
    { id: 5, title: 'Phá băng khi gặp mặt', instructor: 'Võ Thành', duration: '12 phút', lessons: 4, difficulty: 'Cơ bản', progress: 0, rating: 4.5, category: 'Giao tiếp' },
    { id: 6, title: 'Chọn nhà hàng phù hợp', instructor: 'Hoàng Yến', duration: '15 phút', lessons: 5, difficulty: 'Cơ bản', progress: 0, rating: 4.8, category: 'Ẩm thực' },
  ];
