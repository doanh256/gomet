...
const AcademyPage = () => {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}><button style={s.backBtn} onClick={() => navigate(-1)}><span aria-hidden="true" className="material-symbols-outlined">arrow_back</span></button><h1 style={s.pageTitle}>Hoc vien GOMET</h1><span className="material-symbols-outlined filled" style={s.schoolIcon}>school</span></div>
      <p style={s.subtitle}>Nang cao ky nang hen ho</p>
      <div style={s.featuredCard}><div style={s.featuredImage}><span aria-hidden="true" className="material-symbols-outlined" style={s.featuredImageText}>auto_stories</span></div><div style={s.featuredBody}><div style={s.featuredTitle}>Nghe thuat tro chuyen</div><div style={s.featuredInstructor}><div style={s.instructorAvatar}>TM</div><span style={s.instructorName}>Tran Minh</span></div><div style={s.featuredMeta}><span style={s.metaItem}><span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: '16px' }}>menu_book</span>8 bai hoc</span><span style={s.metaItem}><span aria-hidden="true" className="material-symbols-outlined" style={{ fontSize: '16px' }}>schedule</span>30 phut</span></div><div style={s.progressBarWrap}><div style={s.progressBarFill(40)} /></div><button style={s.startBtn}>Bat dau</button></div></div>
