...
const TrendingPage = () => {
  ...
  return (
    <div style={s.page}>
      <div style={s.header}><button style={s.backBtn} onClick={() => navigate(-1)}><span aria-hidden="true" className="material-symbols-outlined">arrow_back</span></button><h1 style={s.pageTitle}>Xu huong</h1><span aria-hidden="true" className="material-symbols-outlined" style={s.trendIcon}>trending_up</span></div>
