    ...
    <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(19,19,19,0.95)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ background: '#1C1B1B', borderRadius: '1.5rem', padding: '40px 32px', maxWidth: 380, width: '90%', textAlign: 'center', animation: 'fadeInUp 0.6s ease-out', position: 'relative', zIndex: 2 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 16, marginBottom: 24 }}>
          <div style={avatarStyle(0)}>{matchData.user1.avatar ? <img src={matchData.user1.avatar} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : <span className="material-symbols-outlined" style={{ fontSize: 36, color: '#E6BEB2' }}>person</span>}</div>
          ...
          <div style={avatarStyle(1)}>{matchData.user2.avatar ? <img src={matchData.user2.avatar} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} /> : <span className="material-symbols-outlined" style={{ fontSize: 36, color: '#E6BEB2' }}>person</span>}</div>
        </div>
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: '#2A2A2A', color: '#FFB59E', borderRadius: '9999px', padding: '6px 16px', fontSize: 14, fontWeight: 600, marginBottom: 24 }}><span className="material-symbols-outlined" style={{ fontSize: 18 }}>monitoring</span>{matchData.percentage}% tuong thich</div>
